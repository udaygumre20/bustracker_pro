...
import { HomeIcon, BellIcon, UserIcon, CloseIcon, BusIcon, SettingsIcon } from './icons';
...
const NavItem: React.FC<{
  ...
  <button
    ...
    className={`flex items-center w-full p-3 rounded-lg text-left transition-colors duration-200 ${
      isActive ? 'bg-primary/10 text-primary dark:bg-accent/20 dark:text-accent font-semibold' : 'text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700'
    }`}
  >
